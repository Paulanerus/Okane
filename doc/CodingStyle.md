# Okane C++ coding style

**The coding style for Okane is nearly identical to the style guide used by the [Ladybird project](https://github.com/LadybirdBrowser/ladybird/tree/master).**

This document describes the coding style used for C++ code in the Okane project. All new code should conform to this style.
...
- Use snake_case (all lowercase, with underscores separating words) for variable and function names as well as internal classes and structs
